/**
 * DepartmentJamsView — Panorama nacional Waze TVT agrupado por departamento.
 *
 ...
 *
 * Decisiones:
 *  - Sin click-to-twin (a propósito; los twins SUMO viven en la tabla
 *    AlertaDITRA original)
 ...
 *  - Tooltip on hover sobre cada polilínea con nombre + nivel + km + min + multiplicador
 */
